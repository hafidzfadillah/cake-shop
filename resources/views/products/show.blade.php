...
<div class="max-w-6xl mx-auto mt-6 px-4">
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="md:flex">
            ...
            <div class="md:w-1/2">
                <!-- Gambar Utama Produk -->
                <img src="{{ $product->prod_img_url }}" alt="{{ $product->prod_name }}" class="w-full h-96 object-cover"
                loading="lazy">
    ...
    <div class="mt-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            @foreach($product->category->products->where('prod_id', '!=', $product->prod_id)->take(4) as $relatedProduct)
                ...
                <img src="{{ $relatedProduct->prod_img_url }}" alt="{{ $product->prod_name }}" class="product-image w-full h-48 object-cover"
                loading="lazy">
                    <div class="p-4">
